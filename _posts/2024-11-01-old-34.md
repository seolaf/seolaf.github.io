---
title: ["[Webhacking.kr] old-34 (misc - 40)"]
...
문제에 접속하면 alert창이 뜬다.  
Burp로 잡아서 response를 보면 아래와 같은 코드를 볼 수 있다.  
...
online 툴을 사용해서 난독화를 풀면 아래와 같은 코드가 나온다.  
